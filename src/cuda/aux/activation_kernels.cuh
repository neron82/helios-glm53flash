...
// _silu(float) comes from helios_shim.cuh (single shared definition, byte-identical body).
...
// _sigmoid_fast_exp(float) comes from helios_shim.cuh (single shared definition).
