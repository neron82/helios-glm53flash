...
// Ported into helios::exl3: torch's device-guard/TLS machinery is gone, so the launchers
// resolve the current device with cudaGetDevice() and pass locks + an explicit stream down.
namespace helios
{
namespace exl3
{
